		...
		void InitializeComponent(void)
		{
			...
			this->toolStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(22) {
				this->newToolStripButton,
					...
					this->toolStripButton6, this->toolStripSeparator4, this->toolStripButton7, this->toolStripButton8, this->toolStripSeparator5
			});
			this->toolStrip1->Location = System::Drawing::Point(0, 28);
			this->toolStrip1->Name = L"toolStrip1";
			this->toolStrip1->Size = System::Drawing::Size(777, 27);
			...
			this->toolStripButton1->Text = L"Âèğ³âíşâàííÿ ïî ë³âîìó êğàş";
			...
			this->toolStripButton3->Text = L"Âèğ³âíşâàííÿ ïî ïğàâîìó êğàş";
			...
			this->richTextBox1->Size = System::Drawing::Size(777, 463);
			...
			this->âèğ³çàòèToolStripMenuItem1->Click += gcnew System::EventHandler(this, &MyForm::cutToolStripButton_Click);
			// 
			...
			this->êîï³şâàòèToolStripMenuItem1->Click += gcnew System::EventHandler(this, &MyForm::copyToolStripButton_Click);
			// 
			...
			this->statusStrip1->Location = System::Drawing::Point(0, 492);
			this->statusStrip1->Name = L"statusStrip1";
			this->statusStrip1->Size = System::Drawing::Size(777, 26);
			...
			this->ñòâîğèòèToolStripMenuItem->Size = System::Drawing::Size(157, 26);
			this->ñòâîğèòèToolStripMenuItem->Text = L"Ñòâîğèòè";
			this->ñòâîğèòèToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::newToolStripButton_Click);
			// 
			// â³äêğèòèToolStripMenuItem
			// 
			this->â³äêğèòèToolStripMenuItem->Name = L"â³äêğèòèToolStripMenuItem";
			this->â³äêğèòèToolStripMenuItem->Size = System::Drawing::Size(157, 26);
			...
			this->çáåğåãòèToolStripMenuItem->Size = System::Drawing::Size(157, 26);
			...
			this->toolStripMenuItem2->Text = L"Ïàíåë³";
			...
			this->ïàíåë³²íñòğóìåíò³âToolStripMenuItem->Size = System::Drawing::Size(236, 26);
			this->ïàíåë³²íñòğóìåíò³âToolStripMenuItem->Text = L"Ïàíåëü ³íñòğóìåíò³â";
			this->ïàíåë³²íñòğóìåíò³âToolStripMenuItem->CheckStateChanged += gcnew System::EventHandler(this, &MyForm::ïàíåë³²íñòğóìåíò³âToolStripMenuItem_CheckStateChanged);
			...
			// 
			this->ôîíToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(5) {
				this->÷åğâîíèéToolStripMenuItem,
					this->ñèí³éToolStripMenuItem, this->çåëåíèéToolStripMenuItem, this->æîâòèéToolStripMenuItem, this->÷îğíèéToolStripMenuItem
			});
			...
			this->ôîíToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::RichTextBox1_Click);
			// 
			...
			this->æîâòèéToolStripMenuItem->Click += gcnew System::EventHandler(this, &MyForm::æîâòèéToolStripMenuItem_Click);
			// 
			...
			this->ClientSize = System::Drawing::Size(777, 518);
...
private: System::Void ïàíåë³²íñòğóìåíò³âToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
	statusStrip1->Visible = ïàíåë³²íñòğóìåíò³âToolStripMenuItem->Checked;
}
...
private: System::Void ïàíåë³²íñòğóìåíò³âToolStripMenuItem_CheckStateChanged(System::Object^ sender, System::EventArgs^ e) {
	bool prap;
	if (ïàíåë³²íñòğóìåíò³âToolStripMenuItem->Checked)
		prap = true;
	else
		prap = false;
	if (prap == true)
